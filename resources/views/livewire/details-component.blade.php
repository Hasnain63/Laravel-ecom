                                ...
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ route('product.detail',['slug'=>$product->slug])}}"
                                            title="{{$popular->name}}">
                                            <figure><img src="{{asset('assets/images/products')}}/{{$popular->image}}"
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span
                                                class="product-price">Rs{{$popular->regular_price}}</span></div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('product.detail',['slug'=>$product->slug])}}"
                                        ...
                                        <figure><img src="{{asset('assets/images/products')}}/{{$related->image}}"
                                                width="214" height="214" alt="{{$related->name}}"></figure>
                                    </a>
                                ...
                                <div class="product-info">
                                    <a href="{{ route('product.detail',['slug'=>$product->slug])}}"
                                        class="product-name"><span>{{$related->name}}</span></a>
                                    <div class="wrap-price"><span
                                            class="product-price">Rs{{$related->regular_price}}</span></div>
                                </div>
                            </div>
                            @endforeach
                        </div>
